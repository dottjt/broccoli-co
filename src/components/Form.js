...
import { FormButton, FormRecaptcha, FormError, FormInput } from './FormUtilities';

const Form = observer(({ store }) => (
  <div className={`form__underlay__${store.isFormVisible}`}>
    <div className="form">
      ...
      <div className="form__submission__container">
        <FormRecaptcha onFormVerification={store.onFormVerification} onFormVerificationExpiration={store.onFormVerificationExpiration} />
